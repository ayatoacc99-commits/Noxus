          ...
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative my-2">
                <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-noxus-border" /></div>
                <div className="relative flex justify-center text-xs"><span className="bg-noxus-card px-2 text-noxus-muted">or</span></div>
              </div>

              <Button type="button" variant="outline" className="w-full h-11 gap-2" onClick={loginDiscord}>
